...
function screenController() {
    ...
    const newTaskIndexOne = defaultList.addToDo("Default Task 1", "Default Project", "This is a default task, autogenerated on page load.");
    const newTaskIndexTwo = defaultList.addToDo("Default Task 2", "Default Project", "This is a default task, autogenerated on page load.");
    const newTaskIndexThree = defaultList.addToDo("Default Task 3", "Default Project", "This is a default task, autogenerated on page load.");
    const newTaskIndexFour = defaultList.addToDo("Default Task 4", "Default Project", "This is a default task, autogenerated on page load.");
